...
"""
ESP32
Wi-Fi Fake Channel Hopping Access Point

https://docs.micropython.org/en/latest/library/network.html
https://mpython.readthedocs.io/en/latest/library/micropython/network.html

Prompt: Write a script in MicroPython to create fake channel hopping access point with an ESP32.
"""
...
# Main
print("Wi-Fi Fake Channel Hopping Access Point")
print()
...
while True:
    for i in range(1, 14, 1):
        ...
        #       max_clients/'max_clients' => Clients numbers
        #       txpower/'txpower' => TX power in dB
        ap.config(essid="h4ck3r", channel=i, hidden=False, authmode=network.AUTH_WPA_WPA2_PSK, password="12345678a", max_clients=10)
