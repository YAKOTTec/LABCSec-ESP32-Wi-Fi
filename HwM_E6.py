...
"""
ESP32
Wi-Fi DHCP Starvation Attack

https://docs.micropython.org/en/latest/library/network.html
https://mpython.readthedocs.io/en/latest/library/micropython/network.html

Prompt: Write a script in MicroPython to connect 255 times to an access points with an ESP32. Change the MAC address of the ESP32. Change the IP address of the ESP32.
"""
...
# Main
print("Wi-Fi DHCP Starvation Attack")
print()
